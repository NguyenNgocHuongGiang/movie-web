    ...
    className="w-full max-w-md p-8 space-y-3 rounded-xl bg-gray-100 bg-opacity-70 dark:text-gray-800">
      ...
      <div className="space-y-6">
        ...
        //   onChange={formik.handleChange} 
          id="hoTen" placeholder="Họ tên" className="w-full px-4 py-3 rounded-md  bg-gray-50 text-gray-800 focus:border-yellow-400" />
        </div>
        <div className="space-y-1 text-sm">
          <label htmlFor="email" className="block dark:text-gray-600">Email</label>
          <input type="email" name="email" 
        //   onChange={formik.handleChange} 
          id="email" placeholder="Email" className="w-full px-4 py-3 rounded-md  bg-gray-50 text-gray-800 focus:border-yellow-400" />
        </div>
        <div className="space-y-1 text-sm">
          <label htmlFor="soDT" className="block dark:text-gray-600">Số điện thoại</label>
          <input type="text" name="soDT" 
        //   onChange={formik.handleChange} 
        id="soDT" placeholder="Số điện thoại" className="w-full px-4 py-3 rounded-md  bg-gray-50 text-gray-800 focus:border-yellow-400" />
        </div>
        <div className="space-y-1 text-sm">
